...
class FlareDetection:
    ...
    def __init__(self, model_id="33ad4d2d26fe416db7dd9eda2e4fd2fb", standard_cnn=True, device=None):
        if device is None:
    ...
    def detect(self, datetime, instrument="Australia-ASSA_62", window_length="1h"):
        ...
        if window_length < pd.to_timedelta("15min"):
            raise ValueError("window_length must be at least 15min")
